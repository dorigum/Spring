           ...
           <section>
                ...
                <article  id="content2"> <!-- 베스트 상품 -->   
            		<div id="productBox">
            			<h3>베스트 상품</h3>
            			<div class='product'>
            				<div><a href="#"><img src="<c:url value='/image/prd1.jpg'/>"></a></div>
            				<div><a href="#"><img src="<c:url value='/image/prd2.jpg'/>"></a></div>
            				<div><a href="#"><img src="<c:url value='/image/prd3.jpg'/>"></a></div>
            			</div>
            			<div class='product'>
            				<div><a href="#"><img src="<c:url value='/image/prd5.jpg'/>"></a></div>
            				<div><a href="#"><img src="<c:url value='/image/prd6.jpg'/>"></a></div>
            				<div><a href="#"><img src="<c:url value='/image/prd7.jpg'/>"></a></div>
            			</div>
					</div>         	
                </article>
            </section>
