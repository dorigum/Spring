...
public class ProductController {
	...
	public String viewProductList(Model model) {
		...
		// 뷰 페이지 이름 반환 (view 폴더 안의 product 폴더 안의 productListView.jsp)
	}
	...
	public String detailViewProduct(@PathVariable String prdNo, Model model) {
		...
		return "product/productDetailView"; // productDetailView.jsp 상품 상세 정보 페이지
	}
	
	// 상품 정보 수정 화면으로 이동 (데이터를 수정할 수 있도록 상세 정보를 화면(입력란)에 출력)
